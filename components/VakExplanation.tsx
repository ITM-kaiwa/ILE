...
export const VakExplanation: React.FC<VakExplanationProps> = ({ vakType, lang = 'ja' }) => {
  const isVi = lang === 'vi';
  return (
    <div className="space-y-6 text-left mt-6 bg-white p-6 rounded-2xl border border-amber-100 shadow-inner">
        ...
        <div className="space-y-4">
          <div>
            <h4 className="font-bold text-indigo-800 flex items-center mb-2 text-lg border-b border-indigo-100 pb-2">
              ...
              {isVi ? '【Đặc điểm & Phương pháp】' : '【特性と学習法】'}
            </h4>
          ...
          <div>
            <h4 className="font-bold text-indigo-800 mb-2">{isVi ? '【Ưu điểm chính】' : '【主な長所】'}</h4>
          ...
          <div>
            <h4 className="font-bold text-indigo-800 mb-2">{isVi ? '【Phương pháp học phù hợp】' : '【適している学習法】'}</h4>
            <ul className="text-sm text-slate-700 space-y-2 list-disc list-inside ml-2">
      ...
      {vakType === 'auditory' && (
        <div className="space-y-4">
          ...
          <div>
            <h4 className="font-bold text-emerald-800 mb-2">{isVi ? '【Ưu điểm chính】' : '【主な長所】'}</h4>
            <ul className="text-sm text-slate-700 space-y-2 list-disc list-inside ml-2">
          ...
          <div>
            <h4 className="font-bold text-emerald-800 mb-2">{isVi ? '【Phương pháp học phù hợp】' : '【適している学習法】'}</h4>
            <ul className="text-sm text-slate-700 space-y-2 list-disc list-inside ml-2">
      ...
      {vakType === 'kinesthetic' && (
        <div className="space-y-4">
          ...
          <div>
            <h4 className="font-bold text-orange-800 mb-2">{isVi ? '【Ưu điểm chính】' : '【主な長所】'}</h4>
            <ul className="text-sm text-slate-700 space-y-2 list-disc list-inside ml-2">
          ...
          <div>
            <h4 className="font-bold text-orange-800 mb-2">{isVi ? '【Phương pháp học phù hợp】' : '【適している学習法】'}</h4>
            <ul className="text-sm text-slate-700 space-y-2 list-disc list-inside ml-2">
      ...
      <div className="pt-4 border-t border-slate-200 mt-6 bg-slate-50 p-4 rounded-xl border">
        <h4 className="font-bold text-amber-800 flex items-center mb-2">
          ...
          {isVi ? '【Tiếp cận đa giác quan】' : '【効率を高める多覚的アプローチ】'}
        </h4>
        <p className="text-sm text-slate-700 leading-relaxed">
          {isVi ? (
          <>
