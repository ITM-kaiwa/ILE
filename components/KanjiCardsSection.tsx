...
const LANGOAL_N5_ORDER = ["日","本","力","一","目","高","読","方","書","見","立","時","間","大","手","分","二","三","四","五","六","七","八","九","十","百","千","円","月","火","水","木","金","土","年","人","子","男","女","父","母","体","口","耳","足","上","下","左","右","小","中","外","学","校","先","生","名","友","山","川","田","石","雨","夕","岩","音","物","林","森","花","竹","犬","貝","牛","魚","鳥","食","米","肉","茶","好","今","何","半","町","寺","東","西","南","北","車","電","安","多","少","新","古","明","暗","長","元","気","入","出","休","行","来","言","帰","話","聞","飲","買"];
const LANGOAL_N4_ORDER = ["文","字","漢","語","試","験","合","使","画","数","方","料","教","発","業","集","台","習","朝","昼","晩","夜","前","後","正","午","毎","週","去","家","族","兄","弟","姉","妹","夫","妻","主","奥","私","王","様","才","色","赤","青","白","黒","銀","黄","緑","丸","玉","天","春","夏","秋","冬","空","風","雲","雪","晴","星","光","自","然","地","谷","草","原","海","湖","池","服","里","野","虫","羽","馬","鳴","毛","糸","衣","洋","理","飯","麦","油","酒","味","住","所","都","道","府","県","京","市","区","村","番","号","国","紙","店","客","売","品","薬","待","計","辺","交","通","荷","送","宅","止","急","特","鉄","船","場","部","屋","室","会","社","駅","工","病","院","公","園","図","館","映","勉","強","宿","題","質","問","答","考","科","英","化","育","研","究","医","政","治","経","済","歴","史","運","動","泳","旅","世","界","練","写","真","楽","声","歌","作","思","持","当","知","働","始","終","乗","降","開","閉","着","走","歩","近","遠","重","軽","早","速","遅","広","細","太","暑","寒","低","短","弱","若","静","有","心","同","便","利","親","切","不"];
