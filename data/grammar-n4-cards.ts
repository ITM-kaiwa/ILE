import { GrammarCard } from '@/lib/types';

export const VNJPCLUB_N4_GRAMMAR_CARDS: GrammarCard[] = [
  {
    "id": "card_n4_1",
    "level": "N4",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第27課：可能形 (Động từ khả năng: Có thể làm...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **グループ1: i➔eます | グループ2: 〜られます | グループ3: できます** | ハイライト | Thể khả năng: Có thể làm V |\n\n> 💡 VNJPClub公式図解カード",
      "auditory": "### 👂 聴覚朗読 (第27課)\n- 「話せる・読める・食べられる」と唱える。",
  ...
  },
  {
    ...
    "vnjpclubUrl": "https://www.vnjpclub.com/ngu-phap-n4/bai-27.html",
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第27課：可能形 (Động từ khả năng: Có thể làm...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **グループ1: i➔eます | グループ2: 〜られます | グループ3: きます➔こられます / します➔できます** | ハイライト | Thể khả năng: Có thể làm V / Biểu thị khả năng hoặc điều kiện cho phép |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第31課：意向形 / 〜ようと思っています (Thể ý định / Ý định làm gì))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **グループ1: o行＋う | グループ2: 〜よう | グループ3: こよう/しよう ＋ と思っています** | ハイライト | Dự định làm V (Thể ý định dùng trong giao tiếp thân mật hoặc diễn tả dự định cá nhân) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第32課：〜ほうが いいです / 〜でしょう / 〜かもしれません (Lời khuyên & Dự đoán))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **Vた/Vない ＋ ほうがいいです | 普通形 ＋ でしょう / かもしれません** | ハイライト | Nên/Không nên làm V | Có lẽ là... | Có thể là... (~50%) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第33課：命令形 / 禁止形 / 〜と書いてあります (Thể mệnh lệnh & Thể cấm đoán))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **命令形: e段 / 〜ろ | 禁止形: V辞書形 ＋ な | 〜という意味です / 〜と書いてあります** | ハイライト | Hãy làm! / Khốn làm! (Mệnh lệnh/Cấm đoán) | Có nghĩa là... | Có ghi là... |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第34課：〜とおりに / 〜あとで / 〜て / 〜ないで (Làm theo / Sau khi / Không làm...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **V1-た/Nの ＋ とおりに | V1-た/Nの ＋ あとで | V1-ないで ＋ V2** | ハイライト | Làm theo như... | Sau khi làm... | Làm V2 mà không làm V1 |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第35課：条件形 〜えば / 〜なら (Thể điều kiện: Nếu... thì...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **グループ1: e段＋ば | グループ2: 〜れば | ナ形/N: なら** | ハイライト | Nếu... thì... (Thể điều kiện giả định hoặc điều kiện phát sinh kết quả) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第36課：〜ように します / 〜ように なります (Mục đích & Sự thay đổi thói quen))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **V辞書形/Vない ＋ ようにします | V辞書形/可能形 ＋ ようになります** | ハイライト | Cố gắng làm V / Trở nên có thể làm V (Thói quen, mục đích) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第37課：受動形 (Thể bị động: Bị / Được...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **グループ1: a段＋れる | グループ2: 〜られる | グループ3: こられる / される** | ハイライト | Bị / Được ai đó làm gì (Biểu thị góc nhìn của người tiếp nhận hành động) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第38課：〜の（名詞化） (Danh từ hóa động từ: Việc làm V...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **V普通形 ＋ のは Adj です / のが 好きです / のを 忘れました** | ハイライト | Việc làm V thì... / Thích việc làm V / Quên mất việc làm V |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第39課：〜て / 〜ので (Nguyên nhân - Lý do: Vì... nên...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **V-て / 形-くて / Nで ＋ ... | 普通形 (ナ形/N な) ＋ ので** | ハイライト | Vì... nên... (Diễn tả nguyên nhân kết quả tự nhiên, khách quan) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第40課：疑心節 〜か / 〜かどうか (Câu hỏi nghi vấn lồng trong câu))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **疑問詞 ＋ 普通形 ＋ か | 普通形 ＋ かどうか (調べる/確かめる/みる)** | ハイライト | Có... hay không / Liệu rằng... (Kiểm tra, xác nhận, thử làm) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第41課：授受表現 ( Cho và Nhận: やります/くださいました/いただきました ))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **N に N を やります / くださいます / いただきます** | ハイライト | Cho (cấp dưới/động vật) / Người trên cho mình / Mình nhận từ người trên |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第42課：〜ために / 〜に (Mục đích: Để làm gì / Cho việc gì))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **V辞書形/Nの ＋ ために | V辞書形/N ＋ に (使います/便利です)** | ハイライト | Để... / Phục vụ cho... (Mục đích rõ ràng, quyết tâm) |\n\n> 💡 VNJPClub公式図解カード",
      "auditory": "### 👂 聴覚朗読 (第42課)\n- 「将来のために勉強する！」と力強く目標唱え。",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第43課：〜そうです (Có vẻ như... / Trông có vẻ...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **Vます形/形 ＋ そうです** | ハイライト | Trông có vẻ... / Sắp... (Dự đoán qua thị giác) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第44課：〜すぎます / 〜やすく・にくくします (Quá mức / Dễ - Khó làm...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **Vます形/形 ＋ すぎます | Vます形 ＋ やすいです / にくいです** | ハイライト | Quá... (Vượt mức) / Dễ làm V / Khó làm V |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第45課：〜ばあいは / 〜のに (Trường hợp... / Thế mà, mặc dù...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **普通形 (ナ形/N な) ＋ 場合は | 普通形 (ナ形/N な) ＋ のに** | ハイライト | Trong trường hợp... / Mặc dù... thế mà... (Bất ngờ, bất mãn) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第46課：〜ところです / 〜はずです (Vừa mới / Chắc chắn là...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **V辞書形/て形/た形 ＋ ところです | 普通形 ＋ はずです** | ハイライト | Sắp sửa... / Đang... / Vừa mới... | Chắc chắn là... |\n\n> 💡 VNJPClub公式図解カード",
      "auditory": "### 👂 聴覚朗読 (第46課)\n- 「たった今終わったところです！」と報告音読。",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第47課：〜そうです (Nghe nói là...) / 〜ようです (Hình như là...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **普通形 ＋ そうです (伝聞) | 普通形 (ナ形な/Nの) ＋ ようです (推測)** | ハイライト | Nghe nói là... (Truyền đạt lại) / Hình như là... (Cảm nhận bằng giác quan) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第48課：使役形 (Thể sai khiến: Cho phép / Bắt làm...))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **グループ1: a段＋せる | グループ2: 〜させる | グループ3: こさせる / される** | ハイライト | Cho phép làm V / Bắt ai đó làm V |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第49課：尊敬語 (Kính ngữ: Tôn vinh hành動 của đối phương))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **お Vます形 になります / 特殊尊敬語 (いらっしゃいます/おっしゃいます/ご覧になります)** | ハイライト | Kính ngữ (Tôn vinh hành動 của ngài/thầy/khách hàng) |\n\n> 💡 VNJPClub公式図解カード",
  ...
  },
  {
    ...
    "vakContent": {
      "visual": "### 👁️ 視覚イメージ解説 (第50課：謙譲語 (Khiêm nhường ngữ: Hạ thấp hành動 của bản thân))\n| 構造 | 助詞・接続 | 意味 |\n|---|---|---|\n| **お Vます形 します / 特殊謙譲語 (参ります/申します/いたします/いただきます)** | ハイライト | Khiêm nhường ngữ (Hạ thấp bản thân để thể hiện sự khiêm tốn) |\n\n> 💡 VNJPClub公式図解カード",
