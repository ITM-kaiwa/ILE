...
old_external = '''      {/* External Learning Resources Section */}
      {(mode === 'all' || mode === 'external') && ('''

new_tool_render = '''      {/* Tools Section */}
      {(mode === 'all' || mode === 'tool') && (
            ...
            return (
              ...
              >
                <div className="flex items-start space-x-3">
                  <div className={p-2.5 rounded-lg bg-gradient-to-br  text-white shadow-sm}>
...
if old_external in content:
    content = content.replace(old_external, new_tool_render)
else:
    print("Could not find old external")
